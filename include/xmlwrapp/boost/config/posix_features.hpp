...
#  if defined(XMLWRAPP_BOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(XMLWRAPP_BOOST_HAS_WINTHREADS) && !defined(XMLWRAPP_BOOST_HAS_MPTASKS)
#        define XMLWRAPP_BOOST_HAS_PTHREADS
#     endif

      // XMLWRAPP_BOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // XMLWRAPP_BOOST_HAS_CLOCK_GETTIME:
...
#     endif
      ...
      // XMLWRAPP_BOOST_HAS_SCHED_YIELD:
...
#     endif
      ...
      // XMLWRAPP_BOOST_HAS_GETTIMEOFDAY:
      // XMLWRAPP_BOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
