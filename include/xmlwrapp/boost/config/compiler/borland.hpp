...
#if (__BORLANDC__ <= 0x570) || !defined(XMLWRAPP_BOOST_STRICT_CONFIG)
...
#     pragma defineonoption XMLWRAPP_BOOST_CPPUNWIND -x
#  endif
#endif
...
//
#if !defined(_CPPUNWIND) && !defined(XMLWRAPP_BOOST_CPPUNWIND)
...
//
#pragma defineonoption XMLWRAPP_BOOST_DISABLE_WIN32 -A

#define XMLWRAPP_BOOST_COMPILER "Borland C++ version " XMLWRAPP_BOOST_STRINGIZE(__BORLANDC__)
