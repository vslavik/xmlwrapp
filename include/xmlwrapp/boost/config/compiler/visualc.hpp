...
#define XMLWRAPP_BOOST_MSVC _MSC_VER
...
#  define XMLWRAPP_BOOST_NO_DEDUCED_TYPENAME
...
#if !defined(_MSC_EXTENSIONS) && !defined(XMLWRAPP_BOOST_NO_DEPENDENT_TYPES_IN_TEMPLATE_VALUE_PARAMETERS)      // VC7 bug with /Za
#  define XMLWRAPP_BOOST_NO_DEPENDENT_TYPES_IN_TEMPLATE_VALUE_PARAMETERS
#endif

#  define XMLWRAPP_BOOST_NO_INCLASS_MEMBER_INITIALIZATION
#  define XMLWRAPP_BOOST_NO_PRIVATE_IN_AGGREGATE
...
# if _MSC_VER == 1200
#   define XMLWRAPP_BOOST_COMPILER_VERSION 6.0
# elif _MSC_VER == 1300
#   define XMLWRAPP_BOOST_COMPILER_VERSION 7.0
# elif _MSC_VER == 1310
#   define XMLWRAPP_BOOST_COMPILER_VERSION 7.1
# else
#   define XMLWRAPP_BOOST_COMPILER_VERSION _MSC_VER
# endif

#define XMLWRAPP_BOOST_COMPILER "Microsoft Visual C++ version " XMLWRAPP_BOOST_STRINGIZE(XMLWRAPP_BOOST_COMPILER_VERSION)
